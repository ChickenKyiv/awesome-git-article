...
The Forking Workflow is fundamentally different than the other workflows discussed in this course.
...
This means that each contributor has not one, but two Git repositories:
